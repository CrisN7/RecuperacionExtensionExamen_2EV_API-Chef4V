 ...
 */
final class Version20250130091818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, receta_id INT NOT NULL, receta_me_obligo_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_6BAF787054F853F8 (receta_id), INDEX IDX_6BAF787079E3E313 (receta_me_obligo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nutrient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, unidad_de_medida VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nutrient_receta (nutrient_id INT NOT NULL, receta_id INT NOT NULL, INDEX IDX_D04E594627373320 (nutrient_id), INDEX IDX_D04E594654F853F8 (receta_id), PRIMARY KEY(nutrient_id, receta_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE receta (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE receta_nutrient (receta_id INT NOT NULL, nutrient_id INT NOT NULL, INDEX IDX_633E17BD54F853F8 (receta_id), INDEX IDX_633E17BD27373320 (nutrient_id), PRIMARY KEY(receta_id, nutrient_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE step (id INT AUTO_INCREMENT NOT NULL, receta_id INT DEFAULT NULL, receta_me_obligo_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_43B9FE3C54F853F8 (receta_id), INDEX IDX_43B9FE3C79E3E313 (receta_me_obligo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
